...
moon = Object(mass=2, pos=[[1], [0], [0]], momentum=[[0], [20], [0]])
...
P_e, = ax.plot([], color='blue', marker='o', markersize=10)
P_m, = ax.plot([], color='black', marker='o', markersize=3)
...
print('Running...')
f_location = 'outputs/two_body_CFM.mp4'
